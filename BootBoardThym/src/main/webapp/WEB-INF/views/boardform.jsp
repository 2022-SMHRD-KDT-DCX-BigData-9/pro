...
<body class="is-preload">
							...
							<form action="board/write" method="post" enctype="multipart/form-data">
								<div class="row gtr-uniform">
									...
									<div class="col-12">
										...
										<img id="preImage" width= "500px" src="https://dummyimage.com/500x500/ffffff/000000.png&text=preview+image">
									</div>
									<!-- Break -->
									<div class="col-12">
										<ul class="actions">
	...
	<script >
		...
		// photo(input)에 이벤트(파일선택, 변경)이 발생했을 때 img의 src 속성값을 변경
		photo.addEventListener("change", e =>{
			// 첨부댄 이미지를 다룬다.
			setImage(e.target)
		})
		// e.target 이 input이라는 변수로 사용됨
		function setImage(input){ // input : 첨부된 파일을 포함한 input 태그요소
			...
			if(input.files && input.files[0]){
				...
				reader.onload = e => {
					console.log(e )
					// e내 target 내 result내에 문자열로 그림파일 
