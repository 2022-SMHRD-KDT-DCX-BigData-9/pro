                  ...
                  <div class="col-6 col-12-medium" style="width: 100%">
                     ...
                     <form action="board/write" method="post"
                        ...
                        <div class="row gtr-uniform">
                           ...
                           <div class="col-12">
                              <textarea nid="content" placeholder="Enter Content"
                           ...
                           <div class="col-12">
                              <input type="file" id="photo" name="photo"> <img
                                 id="preImage"
...
>>>>>>> branch 'master' of https://github.com/2022-SMHRD-KDT-DCX-BigData-9/pro.git
</html>