...
public class BoardController {
	...
	public String content(@PathVariable("idx") int idx, Model model) throws IOException {
		...
		//2. service : repository 매서드 호출 (select * from bootboard where idx=?)
		
		//3. resitory : idx를 조건으로주는 findby~~ 추상메서드 정의
